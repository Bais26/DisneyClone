    ...
    <div className='flex overflow-x-auto w-full px-16 py-4
     scrollbar-hide scroll-smooth ' ref={elementRef}> 
        {movieList.map((item)=>(
            ...
            className='min-w-full  md:h-[390px] object-cover object-center mr-5 rounded-md hover:border-[4px]
            border-gray-400 transition-all duration-100 ease-inmin-w-full h-[330px]'/>
        ))}
    </div>
    </div>
  )
